...
import prize6 from '../../../assets/img/slider/Contest Page Banner/demo-goaly-banner-1.jpg';
            ...
            sportLockerLogin () {
                if( isAuthenticate()){
                    if(getUserDetails().subscription_status === "subscribed") {
                        ...
                        axios.post("https://cms-tsel.goaly.mobi/StageGoalyApi/sportlock_register",payload)
                        .then(res=>{
