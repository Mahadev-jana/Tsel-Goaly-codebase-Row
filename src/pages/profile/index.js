...
class Profile extends Component {
	...
	getProfileDetails = () => {
		...
		let msisdn = getUserDetails().msisdn;
		// console.log(msisdn ,'phoneNo');
						...
						<div className="col-xs-12 mt-15 pd-0">
								...
								<div className="row">
									...
									<div className="col-xs-6">
										...
										<div className="chk-reward" style={{ top: '0px', padding: 0, marginTop: 10 }}>
											{/* <Link to="/reward" className="btn btn-default chk">
												<i className="fas fa-gift"></i>&nbsp; Check Reward
							   			</Link> */}
											<Link to="/profile/contest/history" class="btn btn-default cts mt-5">
							...
							<div className="col-xs-12 mt-10">
								<div className="pt-input">
									...
									<div className="">
										<h4 className="mt-10 bg-f5">{userData.hasOwnProperty('phone_no') && getUserDetails().msisdn}</h4>
									</div>
								</div>
							</div>
