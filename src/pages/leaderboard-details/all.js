...
class All extends Component {
 ...
 console.log(scoreList)
    ...
    scoreList.map(element => {
      ...
      if (element.user_id.search(id) != -1) {
        ...
        let sub = {
          ...
          "rank": element.rank,
          "history": element.history,
          "subscribe_date":element.subscribe_date,
  ...
  render() {
    ...
    console.log(this.state.fullArray.subscribe_date);
      ...
      <div class="cover-board" style={{ paddingTop: '24px' }}>
        {isUserExistInFirstPart ?
          <>
            ...
            {fullArray.length === 0 ? <button className="btn btn-default w-100" onClick={this.showAll(this.state.fullArray.length - 1)} style={{ border: "1px solid #9C25A8" }}>See All </button> : null}
          ...
          : <>
                ...
                return <>
                  <div class="board shadow">
                    ...
                    {/* {!!score.history && score.history.slice(startIndex, limitTo).map((details, index) => {
                      ...
                      <div style={{color:"#A8A8A8" ,fontSize:"12px",fontStyle:"italic"}}>User Subscribe from <Moment format="ddd, DD/MM/YY">{score.subscribe_date}</Moment> with &nbsp; {score.renewal_count} &nbsp;charge</div>
                  </div>
                  {/* <div class="see-all">
                    <a onClick={this.onSeeAll((score.history.length - 1))}>See All</a>
                  </div> */}
            ...
            <button className="btn btn-default w-100" onClick={this.showAll(this.state.fullArray.length - 1)} style={{ border: "1px solid #9C25A8" }}>See All</button>
